...
<body>
    <header>
        <nav class='navbar border-light border-body navbar-expand-lg headerColor'>
    ...
    <div class='position-absolute top-40 start-50 translate-middle-x'>
        <h1 class='text-black border-bottom border-black'>Вход</h1>
    </div>
    <div class='position-absolute top-50 start-50 translate-middle border border-3 border-primary shadow-lg rounded bg-white'>
        <div class='p-3' style='background-color: #e8e8e8;'>
            <form action="{{route('user.login')}}" method="post">
                @csrf
                <div class='mb-3'>
                    <label class='mb-1 ms-2 text-black'>Логин</label>
                ...
                <div class='mb-3'>
                    <label class='mb-1 ms-2 text-black'>Пароль</label>
            ...
            <div class='d-grid gap-2'>
                <button class='btn btn-primary rounded-pill'>
                    <a class='text-light link-underline link-underline-opacity-0' href="/register">Регистрация</a>
                </button>
            </div>
        </div>
    </div>
