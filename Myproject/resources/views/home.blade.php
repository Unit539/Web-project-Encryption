...
<body>
    ...
    <div class='container'>
        <h1 class='h1 text-black text-center border-bottom border-black'>Шифрование</h1>
    </div>
    <div class='container'>
        <form method="post">
            @csrf
            <div class='container'>
                <div class='mt-3 d-grid gap-2 col-3 mx-auto'>
                    <select name='selector' class='form-select border-black'>
                        <option selected>Выберите тип шифрования</option>
            ...
            <div class='mt-3 form-floating'>
                <textarea id='floatingTextarea' class='form-control border-secondary' name="encryption" placeholder="Введите текст для шифрования:" style='height: 350px'></textarea>
                <label for='floatingTextarea'>Введите текст для шифрования:<label>
            </div>
            <div class='mt-3'>
                <textarea class='form-control textareaHeight border-secondary' disabled>{{$en}}</textarea>
            </div>
            <div class='mt-3 mb-3 d-grid gap-2 col-2 mx-auto'>
                <button class='btn btn-primary' type='send' name='button'>Зашифровать</button>
            </div>
        </form>
    </div>
